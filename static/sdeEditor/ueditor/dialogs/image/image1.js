...
(function () {
    ...
    function initButtons() {
        ...
        dialog.onok = function () {
            ...
            if(list) {
                console.info( "确认保存吗，什么情况。。。。。。。。。。。。。。。。。。。" );
                console.info( list );
                // editor.execCommand('insertimage', list[0]);
                editor.execCommand('inserthtml', toInsertImg(list));
    ...
    function toInsertImg( list ){
        var imgArray = [];
        


        for( var i=0;i<list.length;i++ ){
            imgArray.push('<img src="' + list[i].src + '" width="' + list[i].width + '" height="' + list[i].height + ' "title="' + list[i].title + '" />')
        }
    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            var _this = this,
                ...
                actionUrl = "http://jysz.jyyy.so//common-file/api/fileUpload/singleImg?token=0278b1c1b26b31866090795d8063babd38d0e1cabe0feff21f3be4f499987d88&t=1576568575183&uploadType=1",
